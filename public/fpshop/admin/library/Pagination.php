...
class Pagination
{
    ...
    {   
        ...
        {
            $p = '<ul class="container-item">';
             
            // Nút prev và first
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li class="item-page"><a href="'.$this->__link('1').'">First</a></li>';
                $p .= '<li class="item-page"><a href="'.$this->__link($this->_config['current_page']-1).'">Prev</a></li>';
            }
            ...
            for ($i = 1; $i <= $this->_config['total_page']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    $p .= '<li class="item-page"><span class="item-span">'.$i.'</span></li>';
                }
                else{
                    $p .= '<li class="item-page"><a class="item-link" href="'.$this->__link($i).'">'.$i.'</a></li>';
                }
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li class="item-page"><a class="item-link" href="'.$this->__link($this->_config['current_page'] + 1).'">Next</a></li>';
                $p .= '<li class="item-page"><a class="item-link" href="'.$this->__link($this->_config['total_page']).'">Last</a></li>';
            }
